<form action={{ $action }} method="POST">
    ...
    <div class="form-text mb-2 text-center">{{ $descForm }}</div>
    ...
    <textarea id="descricao" placeholder="Descrição" name="descricao" class="form-control mb-2" style="height: 100px">@isset($descricao){{ $descricao }}@endisset</textarea>
